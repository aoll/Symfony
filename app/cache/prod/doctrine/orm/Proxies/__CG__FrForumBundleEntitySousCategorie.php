 ...
 */
class SousCategorie extends \Fr\ForumBundle\Entity\SousCategorie implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Fr\\ForumBundle\\Entity\\SousCategorie' . "\0" . 'id', '' . "\0" . 'Fr\\ForumBundle\\Entity\\SousCategorie' . "\0" . 'author', '' . "\0" . 'Fr\\ForumBundle\\Entity\\SousCategorie' . "\0" . 'title', '' . "\0" . 'Fr\\ForumBundle\\Entity\\SousCategorie' . "\0" . 'date', '' . "\0" . 'Fr\\ForumBundle\\Entity\\SousCategorie' . "\0" . 'idCategorie');
        }
