...
namespace Proxies\__CG__\Fr\LogBundle\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Log extends \Fr\LogBundle\Entity\Log implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Fr\\LogBundle\\Entity\\Log' . "\0" . 'id', '' . "\0" . 'Fr\\LogBundle\\Entity\\Log' . "\0" . 'username', '' . "\0" . 'Fr\\LogBundle\\Entity\\Log' . "\0" . 'url', '' . "\0" . 'Fr\\LogBundle\\Entity\\Log' . "\0" . 'action', '' . "\0" . 'Fr\\LogBundle\\Entity\\Log' . "\0" . 'date', '' . "\0" . 'Fr\\LogBundle\\Entity\\Log' . "\0" . 'role');
        }
