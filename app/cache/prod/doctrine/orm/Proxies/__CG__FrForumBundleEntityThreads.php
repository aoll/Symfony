 ...
 */
class Threads extends \Fr\ForumBundle\Entity\Threads implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Fr\\ForumBundle\\Entity\\Threads' . "\0" . 'id', '' . "\0" . 'Fr\\ForumBundle\\Entity\\Threads' . "\0" . 'author', '' . "\0" . 'Fr\\ForumBundle\\Entity\\Threads' . "\0" . 'title', '' . "\0" . 'Fr\\ForumBundle\\Entity\\Threads' . "\0" . 'content', '' . "\0" . 'Fr\\ForumBundle\\Entity\\Threads' . "\0" . 'date', '' . "\0" . 'Fr\\ForumBundle\\Entity\\Threads' . "\0" . 'idCategorie', '' . "\0" . 'Fr\\ForumBundle\\Entity\\Threads' . "\0" . 'idSousCategorie');
        }
